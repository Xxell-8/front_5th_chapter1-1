(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function s(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(t){if(t.ep)return;t.ep=!0;const r=s(t);fetch(t.href,r)}})();const m=e=>{var n;e.template?(document.getElementById("root").innerHTML=e.template,(n=e.init)==null||n.call(e)):document.getElementById("root").innerHTML=e};class f{constructor(){}render(){const n=this.getMatched();n&&m(n)}getMatched(){}navigate(){}}const p=()=>({init:()=>{const s=document.querySelector("a");s&&s.addEventListener("click",a=>{a.preventDefault(),window.navigate(a.target.href.replace(location.origin,""))})},template:`
  ...
  `}),g=()=>({init:()=>{const s=document.getElementById("login-form");s&&s.addEventListener("submit",a=>{a.preventDefault(),S({username:new FormData(a.target).get("username"),email:"",bio:""})})},template:`
    <main class="bg-gray-100 flex items-center justify-center min-h-screen">
...
`,h=[{name:"홈",href:"/"},{name:"로그인",href:"/login"}],v=[{name:"홈",href:"/"},{name:"프로필",href:"/profile"},{name:"로그아웃",href:"#",id:"logout"}],x=()=>{const e=()=>{const a=document.getElementById("nav");a&&a.addEventListener("click",t=>{t.preventDefault(),t.target.id==="logout"?N():t.target.href&&t.target.href!==location.href&&window.navigate(t.target.href.replace(location.origin,""))})},n=a=>location.pathname===a?"text-blue-600 font-bold":"text-gray-600",s=`
    ...
    <nav id="nav" class="bg-white shadow-md p-2 sticky top-14">
      <ul class="flex justify-around">
        ${(i()?v:h).map(a=>`<li><a href=${a.href} class="${n(a.href)}" ${a.id?`id=${a.id}`:""}>${a.name}</a></li>`).join("")}
      </ul>
    </nav>
  `;return{init:e,template:s}},d=e=>{const n=x(),s=()=>{var t;n.init(),(t=e.init)==null||t.call(e)},a=`
...
`,O=()=>d(L),P=()=>{const e=M(),n=()=>{const a=document.getElementById("profile-form");a&&a.addEventListener("submit",t=>{t.preventDefault();const r=new FormData(t.target);u({username:(r==null?void 0:r.get("username"))||"",email:(r==null?void 0:r.get("email"))||"",bio:(r==null?void 0:r.get("bio"))||""})})},s=`
    <main class="p-4">
  ...
  `;return{init:n,template:s}},$=()=>d(P()),o={HOME:{name:"홈",path:"/",hash:"#/",component:O},LOGIN:{name:"로그인",path:"/login",hash:"#/login",component:g,isPublic:!0},PROFILE:{name:"프로필",path:"/profile",hash:"#/profile",component:$,isPrivate:!0},PAGE_NOT_FOUND:{name:"404",path:"/404",hash:"#/404",component:p}},I=Object.values(o),i=()=>!!localStorage.getItem("user"),M=()=>i?JSON.parse(localStorage.getItem("user")):null,u=e=>{localStorage.setItem("user",JSON.stringify(e))},S=e=>{u(e),window.navigate(o.HOME.path,!0)},N=()=>{localStorage.clear(),window.navigate(o.LOGIN.path,!0)},A=e=>e.isPublic&&i()?o.HOME:e.isPrivate&&!i()?o.LOGIN:null;class T extends f{constructor(){super()}getMatched(){const n=I.find(a=>a.path===location.pathname);if(!n)return this.navigate(o.PAGE_NOT_FOUND.path,!0),null;const s=A(n);return s?(this.navigate(s.path,!0),null):n.component()}navigate(n,s=!1){s?history.replaceState({},"",n):history.pushState({},"",n),window.dispatchEvent(new Event("popstate"))}}const c=new T;window.navigate=c.navigate;window.addEventListener("popstate",()=>c.render());c.render();
